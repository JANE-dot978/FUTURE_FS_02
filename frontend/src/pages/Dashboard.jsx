...
function Dashboard({ darkMode, setDarkMode }) {
  ...
  const handleEdit = (lead) => { setEditingLead(lead); setShowModal(true); };
    ...
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: bg }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <button
              ...
              style={{
                ...
                color: textPrimary, cursor: 'pointer', fontSize: '0.9rem', fontWeight: '600',
              ...
              {[
                ...
                <div key={i} style={{
                  ...
                  <div style={{ height: '3px', borderRadius: '2px', backgroundColor: darkMode ? '#1a1a1a' : '#eee', overflow: 'hidden' }}>
                    <div style={{
                      height: '100%', borderRadius: '2px', backgroundColor: stat.color,
                  ...
                  {recentLeads.map((lead) => (
                    <div key={lead._id} style={{
                      ...
                      <div style={{
                        ...
                        backgroundColor: { new: 'rgba(78,204,163,0.1)', contacted: 'rgba(232,197,71,0.1)', converted: 'rgba(76,175,80,0.1)', lost: 'rgba(255,68,68,0.1)' }[lead.status],
                        color: { new: '#4ecca3', contacted: '#e8c547', converted: '#4caf50', lost: '#ff4444' }[lead.status],
                      }}>
                        {lead.status}
                      </div>
                    </div>
        ...
        {activeTab !== 'dashboard' && (
          <div>
            <div style={{
              ...
              <input
                style={{
                  flex: 1, padding: '14px 0', backgroundColor: 'transparent',
                  border: 'none', color: textPrimary, fontSize: '0.95rem', outline: 'none',
                }}
                type="text"
      ...
      {toast && (
        <div style={{
          ...
          padding: '14px 20px', borderRadius: '10px', border: '1px solid',
